...
def ocr_class(pic_name,output_path, ocr_lang='chi_sim'):
    r=os.popen('python3 /home/upsquared/py/ocr_class/ocr_class2.py '+ pic_name +' '+ output_path+' '+ocr_lang).read()
    print('ocr class:')
    print(r)
...
def open_door(location):
    os.popen('python3 /home/upsquared/py/gpio.py ' + str(location))
